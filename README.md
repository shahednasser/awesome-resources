...
- :speaker: [Syntax - A Tasty Treats Podcast for Web Developers](https://syntax.fm/): Hosted by Wes Bos Wes Bos & Scott Tolinski. The podcast was started by Wes and Scott in 2017 and has published 680+ podcast episodes on full-stack web development, covering JavaScript Server + Client, the latest Frameworks, HTML, CSS, databases, deployment environments, and a whole lot more!
