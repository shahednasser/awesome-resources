...
### Kotlin
- :video_camera: [Course by Google on Kotlin and Jetpack Compose](https://developer.android.com/courses/android-basics-compose/course)
- :green-book: [Kotlin Cheatsheet](https://devhints.io/kotlin)
- :green_book: [Kotlin org](https://kotlinlang.org/)
- :green_book: [Kotlin FreeCodeCamp](https://www.youtube.com/watch?v=F9UC9DY-vIU&t=1638s)

### R Language
- :green-book: [Course on R](https://www.youtube.com/watch?v=oPjZK4Apgug&list=PLjVLYmrlmjGdmPrz0Lx7smkd0qIKHInOF)
- :green_book: [R cheatsheet](https://www.datacamp.com/cheat-sheet/getting-started-r)
- :green_book: [R freecodecamp](https://www.youtube.com/watch?v=_V8eKsto3Ug)
